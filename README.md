...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-salad-1e27
```

A live public deployment of this template is available at [https://shrill-salad-1e27.templates.workers.dev](https://shrill-salad-1e27.templates.workers.dev)
